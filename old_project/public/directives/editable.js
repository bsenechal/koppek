...
angular.module('admin').directive('ngEditable', function() {
    return {
...
angular.module('admin').directive('ngEditableParagraph', function() {
    return {
        // can be in-lined or async loaded by xhr
        // or inlined as JS string (using template property)
...
angular.module('admin').directive('ngEditableSelect', function() {
    return {
